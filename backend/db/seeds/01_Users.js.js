  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        ...
        { username: 'sarahlovin5', profilePic: 'https://media.licdn.com/mpr/mpr/shrink_200_200/p/3/005/019/28f/1b46279.jpg', email: 'sarahzzzworld@yahoo.com', phone_number: '5551238888', password: encrypt('666')},
