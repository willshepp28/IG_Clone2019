  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        ...
        { username: 'danny_ballin1',profilePic: 'https://media.licdn.com/mpr/mpr/shrink_200_200/AAIA_wDGAAAAAQAAAAAAAAshAAAAJDJkMjVhNWZjLTZjOTktNGI3NC1iNTM4LWQ4MDAwNGE4YzIxNQ.jpg', email: 'dannyballin@gmail.com', phone_number: '9996668888', password: encrypt('555')},
        { username: 'sarahlovin5', profilePic: 'https://www.google.com/search?q=profile+picture+free&biw=1280&bih=726&tbs=isz:ex,iszw:200,iszh:200&tbm=isch&source=lnt#imgrc=dsg8S3WXPqkAvM:', email: 'sarahzzzworld@yahoo.com', phone_number: '5551238888', password: encrypt('666')},
